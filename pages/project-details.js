                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-6">
                            <div className="services-img mb-30">
                                <img src="/img/project-details/project-details1.jpg" alt="Image" />
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <div className="services-item mb-30">
                                <img src="/img/project-details/project-details2.jpg" alt="Image" />
                            </div>
                        </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-4">
                                <div className="services-img">
                                    <img src="/img/project-details/project-details3.jpg" alt="Image" />
                                </div>
                            </div>
